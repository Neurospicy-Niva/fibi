...
class TypeSafetyAndValidationTest {
    ...
    fun `ScheduleExpression validation works correctly`() {
        ...
        assertEquals("0 0 0 ? * *", ScheduleExpression.DAILY.cronExpression)
        assertEquals("0 0 0 ? * MON", ScheduleExpression.MONDAY.cronExpression)
        assertEquals("0 0 0 ? * MON-FRI", ScheduleExpression.WEEKDAYS.cronExpression)
    }
